...
import Image1 from '../../../Assets/Projects/Al_Hussaini_Lavanda/Img1.jpeg'
import Image2 from '../../../Assets/Projects/Al_Hussaini_Lavanda/Img2.jpeg'
import Image3 from '../../../Assets/Projects/Al_Hussaini_Lavanda/Img3.jpeg'
import Image4 from '../../../Assets/Projects/Al_Hussaini_Lavanda/Img4.jpeg'
import Image5 from '../../../Assets/Projects/Al_Hussaini_Lavanda/Img5.png'
import Image6 from '../../../Assets/Projects/Al_Hussaini_Lavanda/Img6.png'
import Image7 from '../../../Assets/Projects/Al_Hussaini_Lavanda/Img7.png'
...
function Alhussaini_Lavanda() {
          ...
          >
            ...
            <div className="relative mt-[100px] md:mt-[150px] z-10 max-w-8xl px-4">
              ...
              <p className="uppercase text-xs md:text-lg md:tracking-[7px] tracking-[4px] text-blue-500 font-bold md:mt-5 p-2 md:p-4 mb-6 montserrat">
                Home &gt; PROJECTS &gt; AL-HUSSAINI LAVANDA
              </p>
            </div>
          </div>
  ...
  <div className="flex flex-col items-center p-6 md:w-1/3" data-aos="zoom-in">
    ...
    <p className="text-base md:text-xl tracking-[4px]">LAVANDA PARK</p>
  </div>
  ...
  <div className="flex flex-col items-center p-6 md:w-1/3" data-aos="zoom-in">
    ...
    <p className="text-base md:text-xl tracking-[4px]">ABHA</p>
  </div>
        ...
        <div data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000">
          <p style={{fontWeight:'bold'}} className=" text-sm md:text-xl text-white tracking-wide leading-relaxed text-center bg-white mt-6 bg-clip-text text-transparent drop-shadow-lg against">
        ...
        <div className="flex flex-col md:flex-row gap-4">
          <div onClick={() => handleImageClick(Image7)} className="flex-1 overflow-hidden rounded-lg group" data-aos="zoom-in-up">
            <div className="relative overflow-hidden transition-transform duration-300 ease-in-out transform group-hover:scale-105">
              <img src={Image7} alt="Mall cafe seating area" className="w-full h-80 object-cover transition-all duration-300" />
          ...
          <div onClick={() => handleImageClick(Image5)} className="flex-1 overflow-hidden rounded-lg group" data-aos="zoom-in-up">
            <div className="relative overflow-hidden transition-transform duration-300 ease-in-out transform group-hover:scale-105">
              <img src={Image5} alt="Paul cafe seating" className="w-full h-80 object-cover transition-all duration-300" />
              <div className="absolute inset-0 bg-black opacity-0 group-hover:opacity-20 transition-opacity duration-300"></div>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-7xl md:mt-[-12px] mx-auto pb-8" data-aos="fade-up">
        <div className="flex flex-col md:flex-row gap-4 px-8">
          <div onClick={() => handleImageClick(Image3)} className="flex-1 overflow-hidden rounded-lg group" data-aos="zoom-in-up">
            <div className="relative overflow-hidden transition-transform duration-300 ease-in-out transform group-hover:scale-105">
              <img src={Image3} alt="Mall cafe seating area" className="w-full h-80 object-cover transition-all duration-300" />
              <div className="absolute inset-0 bg-black opacity-0 group-hover:opacity-20 transition-opacity duration-300"></div>
            </div>
          </div>
...
export default Alhussaini_Lavanda
