...
import Image1 from '../../../Assets/Projects/Daiso_Japn_Aziz/Image1.jpg'
import Image2 from '../../../Assets/Projects/Daiso_Japn_Aziz/Image2.jpg'
import Image3 from '../../../Assets/Projects/Daiso_Japn_Aziz/Image3.jpg'
import Image4 from '../../../Assets/Projects/Daiso_Japn_Aziz/Image4.jpg'
import Image5 from '../../../Assets/Projects/Daiso_Japn_Aziz/Image5.jpg'
import Image6 from '../../../Assets/Projects/Daiso_Japn_Aziz/Image6.jpg'
import Image7 from '../../../Assets/Projects/Daiso_Japn_Aziz/Image7.jpg'
import Image8 from '../../../Assets/Projects/Daiso_Japn_Aziz/Image8.jpg'
          ...
          >
            ...
            <div className="relative mt-[100px] md:mt-[150px] z-10 max-w-8xl px-4">
              ...
              <p className="uppercase text-xs md:text-lg md:tracking-[7px] tracking-[4px] text-blue-500 font-bold md:mt-5 p-2 md:p-4 mb-6 montserrat">
                Home &gt; PROJECTS &gt;DAISO JAPAN AZIZ MALL
              </p>
            </div>
          </div>
...
<div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center md:items-stretch justify-between text-white text-center gap-y-8 md:gap-y-0">
  ...
  <div className="flex flex-col items-center p-6 md:w-1/3" data-aos="zoom-in">
    ...
    <p className="text-base md:text-xl tracking-[4px]">AZIZ MALL</p>
  </div>
  ...
  <div className="flex flex-col items-center p-6 md:w-1/3" data-aos="zoom-in">
    ...
    <p className="text-base md:text-xl tracking-[4px]">JEDDAH            </p>
  </div>
  ...
  <div data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000">
    ...
    <div className="relative">
      ...
      <div
        ...
        data-aos-delay="300"
      >
    <div onClick={() => handleImageClick(Image1)} className="relative md:w-[700px] w-auto rounded-3xl group overflow-hidden rounded-5xl transition-transform duration-700 ease-in-out hover:scale-[1.02] hover:rotate-[1.0deg] hover:shadow-[0_10px_30px_rgba(0,0,0,0.80)] bg-transparent">
      ...
      <div className="p-8 max-w-7xl mx-auto" data-aos="fade-up">
        <div className="flex flex-col md:flex-row gap-4">
          <div  onClick={() => handleImageClick(Image3)} className="flex-1 overflow-hidden rounded-lg group" data-aos="zoom-in-up">
            <div className="relative overflow-hidden transition-transform duration-300 ease-in-out transform group-hover:scale-105">
              <img src={Image3} alt="Mall cafe seating area" className="w-full h-96 object-cover transition-all duration-300" />
              <div className="absolute inset-0 bg-black opacity-0 group-hover:opacity-20 transition-opacity duration-300"></div>
            </div>
          </div>
          
          <div onClick={() => handleImageClick(Image4)}className="flex-1 overflow-hidden rounded-lg group" data-aos="zoom-in-up">
            <div className="relative overflow-hidden transition-transform duration-300 ease-in-out transform group-hover:scale-105">
              <img src={Image4} alt="Close-up seating" className="w-full h-96 object-cover transition-all duration-300" />
              <div className="absolute inset-0 bg-black opacity-0 group-hover:opacity-20 transition-opacity duration-300"></div>
            </div>
          </div>
           ...
           <div onClick={() => handleImageClick(Image5)}className="flex-1 overflow-hidden rounded-lg group" data-aos="zoom-in-up">
            <div className="relative overflow-hidden transition-transform duration-300 ease-in-out transform group-hover:scale-105">
              <img src={Image5} alt="Close-up ]" className="w-full h-96 object-cover transition-all duration-300" />
              <div className="absolute inset-0 bg-black opacity-0 group-hover:opacity-20 transition-opacity duration-300"></div>
            </div>
          </div>
        </div>
        ...
        <div onClick={() => handleImageClick(Image6)} className="mt-4 overflow-hidden rounded-lg group" data-aos="zoom-in-up">
          <div className="relative overflow-hidden transition-transform duration-300 ease-in-out transform group-hover:scale-110">
            <img src={Image6} alt="Panoramic view" className="w-full h-96 md:h-[500px] sm:h-96 object-cover transition-all duration-300" />
            <div className="absolute inset-0 bg-black opacity-0 group-hover:opacity-20 transition-opacity duration-300"></div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl md:mt-[-12px] mx-auto pb-8" data-aos="fade-up">
        <div className="flex flex-col md:flex-row gap-4 px-8">
          <div onClick={() => handleImageClick(Image4)} className="flex-1 overflow-hidden rounded-lg group" data-aos="zoom-in-up">
            <div className="relative overflow-hidden transition-transform duration-300 ease-in-out transform group-hover:scale-110">
              <img src={Image2} alt="Mall cafe 4thh" className="w-full h-96 object-cover transition-all duration-300" />
              <div className="absolute inset-0 bg-black opacity-0 group-hover:opacity-20 transition-opacity duration-300"></div>
            </div>
          </div>
            ...
            <div className="relative overflow-hidden transition-transform duration-300 ease-in-out transform group-hover:scale-110">
              <img src={Image8} alt="Mall cafe 4thh" className="w-full h-96 object-cover transition-all duration-300" />
              <div className="absolute inset-0 bg-black opacity-0 group-hover:opacity-20 transition-opacity duration-300"></div>
            </div>
          </div>
         ...
         <div onClick={() => handleImageClick(Image7)}className="flex-1 overflow-hidden rounded-lg group" data-aos="zoom-in-up">
            <div className="relative overflow-hidden transition-transform duration-300 ease-in-out transform group-hover:scale-105">
              <img src={Image7} alt="Close-up seating" className="w-full h-96 object-cover transition-all duration-300" />
              <div className="absolute inset-0 bg-black opacity-0 group-hover:opacity-20 transition-opacity duration-300"></div>
            </div>
          </div>
        </div>
...
export default Daiso_Japan_Aziz
