...
import Image1 from '../../../Assets/Projects/Giordano/GIO1.jpeg'
import Image2 from '../../../Assets/Projects//Giordano/GIO2.jpeg'
import Image3 from '../../../Assets/Projects//Giordano/GIO3.jpeg'
import Image4 from '../../../Assets/Projects/Giordano/GIO4.jpeg'
                ...
                >
                  <div className="relative max-w-6xl max-h-[90vh] w-full rounded-lg overflow-hidden bg-white shadow-lg transform transition-all duration-500 ease-in-out scale-95 hover:scale-100">
                    ...
                    <img 
                      src={selectedImage} 
                      alt="Enlarged view" 
                      className="max-h-[90vh] mx-auto rounded-md object-contain rounded-md  transition-transform duration-500 ease-in-out transform hover:scale-105"
    ...
    <span className="bg-white text-[#2d3680] px-3 py-1 rounded-md text-sm md:text-lg font-medium mb-2 mt-2 tracking-[4px]">
      RIYADH
         ...
         <div data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000">
           <p style={{fontWeight:'bold'}} className="tracking-[2px] text-sm md:text-lg font-bold text-white tracking-wide leading-relaxed text-center bg-white mt-6 bg-clip-text text-transparent drop-shadow-lg against">
