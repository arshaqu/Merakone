    ...
    useEffect(() => {
      ...
      {selectedImage && (
         ...
         <div data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000">
           <p style={{fontWeight:'bold'}} className=" text-sm md:text-lg font-bold tracking-[2px] text-white tracking-wide leading-relaxed text-center bg-white mt-6 bg-clip-text text-transparent drop-shadow-lg against">
