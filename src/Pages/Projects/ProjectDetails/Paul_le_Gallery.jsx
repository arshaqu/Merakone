...
import Image2 from '../../../Assets/Projects/Paul_Le_Gallery/IMG1.JPG'
import Image4 from '../../../Assets/Projects/Paul_Le_Gallery/IMG2.JPG'
import Image1 from '../../../Assets/Projects/Paul_Le_Gallery/IMG3.JPG'
import Image3 from '../../../Assets/Projects/Paul_Le_Gallery/IMG4.JPG'
import Image5 from '../../../Assets/Projects/Paul_Le_Gallery/IMG5.JPG'
    ...
    useEffect(() => {
      ...
      return (
       ...
       <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-5 gap-y-8 md:gap-6 text-white text-center">
                    ...
                    {/* Divider */}
                    <div className="hidden md:flex h-32 w-px bg-white m-4 md:m-12"></div>
                    ...
                    {/* Divider */}
                    <div className="hidden md:flex h-36 w-px bg-white  md:m-12"></div>
         ...
         <div data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000">
           <p style={{fontWeight:'bold'}} className=" text-sm tracking-[2px] md:text-lg tracking-[2px] font-bold text-white tracking-wide leading-relaxed text-center bg-white mt-6 bg-clip-text text-transparent drop-shadow-lg against">
...
export default Paul_le_Gallery
