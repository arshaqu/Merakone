...
import Image1 from '../../../Assets/Projects/Sun_Glass_Hut_Panorama/Img1.JPG'
import Image2 from '../../../Assets/Projects/Sun_Glass_Hut_Panorama/Img2.JPG'
import Image3 from '../../../Assets/Projects/Sun_Glass_Hut_Panorama/Img3.JPG'
import Image4 from '../../../Assets/Projects/Sun_Glass_Hut_Panorama//Img4.JPG'

import Aos from 'aos'

function SunGlassHut() {
          ...
          >
            ...
            <div className="relative mt-[100px] md:mt-[150px] z-10 max-w-8xl px-4">
              ...
              <p className="uppercase text-xs md:text-lg md:tracking-[7px] tracking-[4px] text-blue-500 font-bold md:mt-5 p-2 md:p-4 mb-6 montserrat">
                Home &gt; PROJECTS &gt;SUN GLASS HUT PANOMRAMA
              </p>
            </div>
          </div>
...
<div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center md:items-stretch justify-between text-white text-center gap-y-8 md:gap-y-0">
  ...
  <div data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000">
    <p style={{fontWeight:'bold' , letterSpacing:'2px'}} className=" text-sm md:text-xl font-bold text-white  tracking-wide leading-relaxed text-center bg-white mt-6 bg-clip-text text-transparent drop-shadow-lg against">
