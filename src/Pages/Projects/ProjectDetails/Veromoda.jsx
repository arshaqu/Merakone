...
<div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center md:items-stretch justify-between text-white text-center gap-y-8 md:gap-y-0">
  ...
  <div className="flex flex-col items-center p-6 md:w-1/3" data-aos="zoom-in">
    ...
    <p className="text-base md:text-xl tracking-[4px]">AL NAKHEEL MALL</p>
  </div>
  ...
  <div data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000">
    ...
    <div className="relative">
      ...
      <div
        ...
        data-aos-delay="300"
      >
    <div onClick={() => handleImageClick(Image8)} className="relative md:w-[700px] w-auto rounded-3xl group overflow-hidden rounded-5xl transition-transform duration-700 ease-in-out hover:scale-[1.02] hover:rotate-[1.0deg] hover:shadow-[0_10px_30px_rgba(0,0,0,0.80)] bg-transparent">
      ...
      <div className="p-8 max-w-7xl mx-auto" data-aos="fade-up">
        ...
        <div onClick={() => handleImageClick(Image9)} className="mt-4 overflow-hidden rounded-lg group" data-aos="zoom-in-up">
          <div className="relative overflow-hidden transition-transform duration-300 ease-in-out transform group-hover:scale-110">
